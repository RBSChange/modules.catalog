...
try
{
	...
	foreach ($docs as $doc)
	{
		...
		{
			Framework::info(date_Calendar::getInstance()->toString() . ' Migrate cross selling in product ' . $docId . '...');
		}
		echo PHP_EOL, 'id:', $docId;
		
		if (!($doc instanceof catalog_persistentdocument_productdeclination))
		{
