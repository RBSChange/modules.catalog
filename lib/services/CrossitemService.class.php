<?php
/**
 * @method catalog_CrossitemService getInstance()
 */
class catalog_CrossitemService extends f_persistentdocument_DocumentService
{
	...
	{
		return $this->getPersistentProvider()->createQuery('modules_catalog/crossitem');
	}
	...
	{
		return $this->getPersistentProvider()->createQuery('modules_catalog/crossitem', false);
	}
	...
	protected function getCrossitemsInfos($crossitem)
	{
		...
		return array(
			...
			'symetrical' => $ls->trans('m.uixul.bo.general.' . ($crossitem->getSymetrical() ? 'yes' : 'no'), array('ucf')),
			'compiled' => $ls->trans('m.uixul.bo.general.' . ($crossitem->getCompiled() ? 'yes' : 'no'), array('ucf')),
			'autoGenerated' => $ls->trans('m.uixul.bo.general.' . ($crossitem->getAutoGenerated() ? 'yes' : 'no'), array('ucf')),
	...
	public function getResume($document, $forModuleName, $allowedSections = null)
	{
		...
		$ls = LocaleService::getInstance();
		$resume['properties']['compiled'] = $ls->trans('m.uixul.bo.general.' . ($document->getCompiled() ? 'yes' : 'no'), array('ucf'));
		$resume['properties']['autoGenerated'] = $ls->trans('m.uixul.bo.general.' . ($document->getAutoGenerated() ? 'yes' : 'no'), array('ucf'));
