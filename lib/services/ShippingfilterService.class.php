 ...
 * @method catalog_ShippingfilterService getInstance()
 */
class catalog_ShippingfilterService extends f_persistentdocument_DocumentService
{
	...
	{
		return $this->getPersistentProvider()->createQuery('modules_catalog/shippingfilter');
	}
	...
	{
		return $this->getPersistentProvider()->createQuery('modules_catalog/shippingfilter', false);
	}
