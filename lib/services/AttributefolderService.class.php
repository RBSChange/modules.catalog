 ...
 * @method catalog_AttributefolderService getInstance()
 */
class catalog_AttributefolderService extends f_persistentdocument_DocumentService
{
	...
	{
		return $this->getPersistentProvider()->createQuery('modules_catalog/attributefolder');
	}
	...
	{
		return $this->getPersistentProvider()->createQuery('modules_catalog/attributefolder', false);
	}
